...
@NoArg data class HiidoStaticExcel(var sheets: Map<String, HiidoStaticSheet>)
...
// 表格表头索引
@NoArg data class HiidoStaticSheetsIndex(var titleRowIndex: Int, var keysIndexMap: HashMap<String, Int>, var labelIndex: Int,
